...
- Dynamic environment monitoring at **73% lower cost** than state-of-the-art alternatives
...
- Piloted with 100–750 real users, iterating on live feedback
...
| When | Role | Highlight |
|---|---|---|
| 2026 – Present | **Product Intern, Adobe Systems** | Built customer-facing features for AJO's debugging/review flow; shipped an agentic data-processing pipeline & journey-review copilot used by thousands of marketers — the core micro-service is now a foundational library for other teams |
| 2026 – Present | **Founder, Acadika** | Agentic AI automation for schools — see above |
| 2025 | **ML Engineer, Tranzmit Engineering** | Deployed a 4-layer voice agent at 1150ms latency handling 100 concurrent calls on AWS; built the domain's only dashboard surfacing 10+ behavioral parameters with in-call source citation |
| 2025 | **Freelance Business Analyst & Web Developer** | Automated 100+ manual hrs/month for 2 businesses; digitized ₹40L+ in annual fee transactions; improved on-time payments by 39% |
| 2024 – Present | **Android Dev Intern & Team Lead, Dixon IoT Lab** | SadakVision — see above |
